...
wine pyinstaller --noconfirm --onedir --windowed --name 'SubtitleTranslator' --add-data 'core;core' --add-data 'ui;ui' --add-data 'theme.json;.' --add-data 'settings.json;.' --collect-all imageio_ffmpeg --collect-all whisper --exclude-module=matplotlib --exclude-module=IPython --exclude-module=pandas --exclude-module=scipy main.py
"
