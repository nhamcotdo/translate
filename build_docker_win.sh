...
wine pyinstaller --noconfirm --onedir --windowed --name 'SubtitleTranslator' --add-data 'core;core' --add-data 'ui;ui' --add-data 'theme.json;.' --add-data 'settings.json;.' --add-data 'models;models' main.py
"
