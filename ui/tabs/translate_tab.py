...
class TranslateTab(ctk.CTkFrame):
    def __init__(self, master, config_manager, **kwargs):
        ...
        ctk.CTkLabel(self.settings_card, text="Target Lang:", font=ctk.CTkFont(weight="bold")).grid(row=1, column=0, padx=(15, 5), pady=(0, 10), sticky="w")
        ...
        self.lang_entry.grid(row=1, column=1, padx=5, pady=(0, 10), sticky="w")

        ctk.CTkLabel(self.settings_card, text="Chunk Size:", font=ctk.CTkFont(weight="bold")).grid(row=1, column=2, padx=(15, 5), pady=(0, 10), sticky="w")
        ...
        self.chunk_entry.grid(row=1, column=3, padx=5, pady=(0, 10), sticky="w")
        ...
        self.load_btn.grid(row=1, column=4, columnspan=2, padx=15, pady=(0, 10), sticky="w")
        
        self.file_label = ctk.CTkLabel(self.settings_card, text="No file selected...", text_color="gray")
        self.file_label.grid(row=1, column=6, padx=5, pady=(0, 10), sticky="e")
        ...
        ctk.CTkLabel(self.text_frame, text="Input Subtitles (VTT/SRT)", font=ctk.CTkFont(weight="bold")).grid(row=0, column=0, sticky="w", padx=5, pady=5)
        ctk.CTkLabel(self.text_frame, text="Translated Output", font=ctk.CTkFont(weight="bold")).grid(row=0, column=1, sticky="w", padx=5, pady=5)

        self.input_text = ctk.CTkTextbox(self.text_frame, border_spacing=10)
        ...
        self.progress = ctk.CTkProgressBar(self.action_bar, height=12)
